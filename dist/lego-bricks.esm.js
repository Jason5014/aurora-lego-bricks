import { computed, defineComponent, openBlock, createBlock, resolveDynamicComponent, normalizeStyle, normalizeClass, withCtx, createTextVNode, toDisplayString } from 'vue';
...
function useComponentCommon(props, picks) {
...
const transformToComponentProps = (props) => mapValues(props, item => ({
    type: item.constructor,
    default: item
}));

const defaultTextProps = transformToComponentProps(textDefaultProps);
...
export { LText, index as default, install };
